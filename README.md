...
<head>
    ...
    <meta name="description" content="Aurex Web Studio - We build world-class, high-converting luxury websites for growing businesses worldwide.">
    <title>Aurex Web Studio | World-Class Digital Agency</title>
    
    <!-- External CDN Resources (HTTPS relative) -->
        ...
        *, *::before, *::after {
        ...
        .bg-mesh {
            ...
            background: 
                ...
                radial-gradient(circle at 50% 85%, rgba(29, 78, 216, 0.15) 0%, transparent 50%),
                #030712;
            pointer-events: none;
        }
        ...
        .gradient-text {
            background: linear-gradient(135deg, #FFFFFF 0%, #93C5FD 50%, var(--primary-light) 100%);
        ...
        .glass-card:hover {
            ...
            box-shadow: 0 20px 40px -15px rgba(0, 0, 0, 0.5), 0 0 30px 0 var(--primary-glow);
        ...
        .laptop-frame {
            ...
            box-shadow: 0 30px 60px rgba(0,0,0,0.8), 0 0 50px rgba(37, 99, 235, 0.2);
            position: relative;
            overflow: hidden;
        ...
        .mock-nav { height: 30px; background: rgba(255,255,255,0.03); display: flex; align-items: center; padding: 0 12px; gap: 6px; border-bottom: 1px solid rgba(255,255,255,0.05); }
        ...
        .mock-hero-line { height: 16px; background: linear-gradient(90deg, var(--primary) 0%, var(--accent-cyan) 100%); border-radius: 4px; margin-bottom: 10px; width: 80%; }
        .mock-text-line { height: 8px; background: rgba(255,255,255,0.1); border-radius: 4px; margin-bottom: 8px; }
        .mock-card { height: 100px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 10px; }
        ...
        .phone-frame {
            ...
            border-radius: 32px;
            padding: 8px;
            box-shadow: 0 25px 50px rgba(0,0,0,0.9), 0 0 30px rgba(6, 182, 212, 0.3);
            z-index: 10;
        }
        ...
        .comp-list i.fa-xmark { color: #EF4444; }
        .comp-list i.fa-check { color: #10B981; }
...
<body>
    ...
    <header class="header" id="header">
        <div class="container nav-container">
            <a href="#home" class="logo">
                ...
                <span>AUREX <span class="gradient-accent">STUDIO</span></span>
            </a>
            ...
            <div style="display: flex; gap: 1rem; align-items: center;">
                <a href="#contact" class="btn btn-primary" style="padding: 0.75rem 1.5rem; font-size: 0.875rem;">Get Started</a>
    ...
    <section class="hero" id="home">
        <div class="container hero-grid">
            <div class="hero-content reveal">
                <div class="badge"><i class="fa-solid fa-wand-magic-sparkles"></i> World-Class Digital Agency</div>
                <h1 class="hero-title">We Build Websites That <span class="gradient-text">Grow Your Business</span></h1>
                <p class="hero-subheadline">
                    Your website works for you 24/7. Whether you're a restaurant, real estate agency, fashion brand, clinic, or startup, we craft modern digital experiences that capture attention, build ultimate trust, and drive revenue.
                </p>
            ...
            <!-- Dynamic UI Graphic Showcase -->
            <div class="hero-mockup-container reveal">
                <div class="float-badge float-1">
                    <i class="fa-solid fa-bolt" style="color: #F59E0B; font-size: 1.25rem;"></i>
                    <div>
                        <div style="font-weight: 700; font-size: 0.85rem;">Ultra-Fast Performance</div>
                ...
                <div class="float-badge float-2">
                    ...
                    <div>
                        <div style="font-weight: 700; font-size: 0.85rem;">Bank-Grade Security</div>
                ...
                <div class="mockup-wrapper">
                            ...
                            <div class="mock-body">
                                <div>
                                    ...
                                    <div style="display:flex; gap:8px; margin-top:15px;">
                                        <div style="width:60px; height:20px; background:var(--primary); border-radius:4px;"></div>
                                        <div style="width:60px; height:20px; background:rgba(255,255,255,0.1); border-radius:4px;"></div>
                                    </div>
                                </div>
                                <div class="mock-card">
                                    <div style="width:30px; height:30px; border-radius:50%; background:var(--accent-cyan); margin-bottom:10px;"></div>
                                    <div class="mock-text-line"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="phone-frame">
                        <div class="phone-screen">
                            <div style="width:30px; height:4px; background:rgba(255,255,255,0.2); border-radius:2px; margin:0 auto 10px auto;"></div>
    ...
    <section class="section-padding" id="why-us">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-chart-line"></i> Essential Growth Engine</div>
            ...
            <div class="comparison-box reveal">
                <div class="comp-column">
                    <h4 style="color: #EF4444;"><i class="fa-solid fa-circle-xmark"></i> Social Media Only</h4>
                    <ul class="comp-list">
                ...
                <div class="comp-column">
                    <h4 style="color: #10B981;"><i class="fa-solid fa-circle-check"></i> Custom Website + Socials</h4>
                    <ul class="comp-list">
    ...
    <!-- Industries -->
    <section class="section-padding" style="background: rgba(15, 23, 42, 0.3);">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-briefcase"></i> Tailored Expertise</div>
    ...
    <section class="section-padding" id="services">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-layer-group"></i> Master Capabilities</div>
    ...
    <section class="section-padding" style="background: rgba(15, 23, 42, 0.4);">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-award"></i> The Aurex Standard</div>
    ...
    <section class="section-padding" id="portfolio">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-eye"></i> Selected Works</div>
            ...
            <div class="portfolio-grid">
                <div class="glass-card portfolio-card reveal">
                    <div class="portfolio-thumb">
                        <div class="thumb-bg">
                            <div style="font-size:0.7rem; color:var(--accent-cyan);"><i class="fa-solid fa-utensils"></i> Cuisine Deluxe</div>
                            <div style="font-size:1.1rem; font-weight:700; margin:10px 0;">Luxury Dining Experience</div>
                            <div style="display:flex; gap:5px; margin-top:20px;">
                                <div style="padding:4px 8px; background:var(--primary); border-radius:4px; font-size:0.6rem;">Table Booking</div>
                                <div style="padding:4px 8px; background:rgba(255,255,255,0.1); border-radius:4px; font-size:0.6rem;">Digital Menu</div>
                            </div>
                        </div>
                    </div>
                    <div class="portfolio-info">
                        ...
                        <p style="color:var(--text-muted); font-size:0.9rem; margin-bottom:1rem;">Integrated digital menus, automated reservations, and elegant aesthetic visual layouts.</p>
                ...
                <div class="glass-card portfolio-card reveal">
                    <div class="portfolio-thumb">
                        <div class="thumb-bg">
                            <div style="font-size:0.7rem; color:var(--accent-cyan);"><i class="fa-solid fa-building"></i> Apex Properties</div>
                            <div style="font-size:1.1rem; font-weight:700; margin:10px 0;">Modern Real Estate Portal</div>
                            <div style="display:flex; gap:5px; margin-top:20px;">
                                <div style="padding:4px 8px; background:var(--primary); border-radius:4px; font-size:0.6rem;">Virtual Tours</div>
                                <div style="padding:4px 8px; background:rgba(255,255,255,0.1); border-radius:4px; font-size:0.6rem;">Property Search</div>
                            </div>
                        </div>
                    </div>
                    <div class="portfolio-info">
                        ...
                        <p style="color:var(--text-muted); font-size:0.9rem; margin-bottom:1rem;">Dynamic property filtering, virtual gallery showcases, and direct agent inquiry channels.</p>
                        <a href="#contact" class="service-link">View Concept Details <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="glass-card portfolio-card reveal">
                    <div class="portfolio-thumb">
                        <div class="thumb-bg">
                            <div style="font-size:0.7rem; color:var(--accent-cyan);"><i class="fa-solid fa-gem"></i> Aurelia Jewels</div>
                            <div style="font-size:1.1rem; font-weight:700; margin:10px 0;">E-Commerce Fashion Store</div>
                            <div style="display:flex; gap:5px; margin-top:20px;">
                                <div style="padding:4px 8px; background:var(--primary); border-radius:4px; font-size:0.6rem;">Checkout Integration</div>
                                <div style="padding:4px 8px; background:rgba(255,255,255,0.1); border-radius:4px; font-size:0.6rem;">Currency Switcher</div>
                            </div>
                        </div>
                    </div>
                    <div class="portfolio-info">
                        ...
                        <p style="color:var(--text-muted); font-size:0.9rem; margin-bottom:1rem;">High-end product visuals, multi-currency support, and seamless payment checkout setup.</p>
                        <a href="#contact" class="service-link">View Concept Details <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
    ...
    <!-- Process -->
    <section class="section-padding" id="process" style="background: rgba(15, 23, 42, 0.3);">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-list-check"></i> Seamless Execution</div>
    ...
    <section class="section-padding">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-comments"></i> Client Trust</div>
    ...
    <!-- FAQ -->
    <section class="section-padding" id="faq" style="background: rgba(15, 23, 42, 0.3);">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-circle-question"></i> Clarity First</div>
    ...
    <section class="section-padding" id="contact">
        <div class="container">
            <div class="section-header text-center reveal">
                <div class="badge"><i class="fa-solid fa-paper-plane"></i> Get In Touch</div>
            ...
            <div class="contact-grid">
                <div class="glass-card contact-info-card reveal">
                    <div>
                        <h3 style="font-size: 1.6rem; margin-bottom: 2rem;">Aurex Web Studio</h3>
                    ...
                    <div>
                        <h4 style="font-size: 0.95rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--text-muted); margin-bottom: 1rem;">Connect With Us</h4>
                ...
                <div class="glass-card contact-form reveal">
                    <form id="project-form" onsubmit="handleFormSubmit(event)">
                        ...
                        <div class="form-group">
                            ...
                            <select id="project-type" class="form-control" style="background: #0F172A;" required>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p>World-class web agency crafting premium, modern, and high-converting websites for businesses ready to dominate online.</p>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            /* ==========================================================================
               1. CANVAS PARTICLE ANIMATION ENGINE
               ========================================================================== */
